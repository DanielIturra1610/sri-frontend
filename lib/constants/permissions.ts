...
export const PERMISSIONS = {
  ...
  // Count permissions (physical inventory)
  COUNTS_VIEW: 'counts.view',
  COUNTS_CREATE: 'counts.create',
  COUNTS_EXECUTE: 'counts.execute',
  COUNTS_COMPLETE: 'counts.complete',
  COUNTS_CANCEL: 'counts.cancel',
} as const;
...
export const ROLE_PERMISSIONS: Record<Role, string[]> = {
  ...
  [ROLES.ADMIN]: [
    ...
    PERMISSIONS.COUNTS_VIEW,
    PERMISSIONS.COUNTS_CREATE,
    PERMISSIONS.COUNTS_EXECUTE,
    PERMISSIONS.COUNTS_COMPLETE,
    PERMISSIONS.COUNTS_CANCEL,
  ],
